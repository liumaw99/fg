...
func (*Message) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case message.FieldContent, message.FieldType, message.FieldClientMessageID, message.FieldStatus:
	...
	for i := range columns {
		...
		case message.FieldClientMessageID:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				m.ClientMessageID = value.String
			}
...
func (m *Message) String() string {
	...
	builder.WriteString(m.ClientMessageID)
	builder.WriteString(", ")
