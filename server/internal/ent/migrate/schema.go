...
var (
	...
	ModerationActionsColumns = []*schema.Column{
		...
		{Name: "target_post_id", Type: field.TypeUUID, Nullable: true},
	...
	// ModerationActionsTable holds the schema information for the "moderation_actions" table.
	ModerationActionsTable = &schema.Table{
		Name:       "moderation_actions",
		Columns:    ModerationActionsColumns,
		PrimaryKey: []*schema.Column{ModerationActionsColumns[0]},
	}
	...
	ReportsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Default: "pending"},
		{Name: "review_notes", Type: field.TypeString, Size: 2147483647, Default: ""},
	...
	ReportsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "report_reporter_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ReportsColumns[1], ReportsColumns[10]},
			},
			{
				Name:    "report_target_user_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ReportsColumns[2], ReportsColumns[10]},
			},
			{
				Name:    "report_target_post_id_created_at",
				Unique:  false,
				Columns: []*schema.Column{ReportsColumns[3], ReportsColumns[10]},
			},
			{
				Name:    "report_status_created_at",
				Unique:  false,
				Columns: []*schema.Column{ReportsColumns[6], ReportsColumns[10]},
			},
		},
	}
